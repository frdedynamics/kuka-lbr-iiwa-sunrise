...
public class Impedance extends RoboticsAPIApplication {
	...
	private static final int stiffnessZ = 50; //2500
	private static final int stiffnessY = 2500; //700
	private static final int stiffnessX = 2500; //1500
	private LBR lbr;
	...
	private static double[] startPosition=new double[]{Math.toRadians(-1.28), Math.toRadians(40.86), Math.toRadians(1.69), Math.toRadians(-83.23), Math.toRadians(1.77), Math.toRadians(-32.53), Math.toRadians(-8.8)};
